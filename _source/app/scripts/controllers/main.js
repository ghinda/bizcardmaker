app.controller('MainCtrl', function($rootScope, $scope, $routeParams, $location, $timeout, $http) {
	...
	angular.forEach(cardChildren, function(c, i) {
	...
	var fixEditorSizes = function(container) {
		...
		var children,
			parentStyle,
			style;
		angular.forEach(editors, function(e, i) {
	...
	$scope.downloadPdf = function() {
		...
		analytics.track('Download PDF', {
			theme: model.themes[model.activeTheme].name
		});
